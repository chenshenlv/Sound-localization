...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 19 22:41:37 2019
...
#   valuesUltrasoundPosition 
#       - buffer of US measured data (address of device, x, y, z (meters), angle (1/10 degree), timestamp (seconds)): [adr, x, y, z, ang, timestamp]
#
#   valuesImuRawData 
#       - buffer of IMU raw measures (accelerometer, gyroscope, compass)
#
#   valuesImuData 
#       - buffer of IMU and US based measures (position, angular position (quaternion), velocities, accelerations): [x, y, z, qw, qx, qy, qz, vx, vy, vz, ax, ay, az, timestamp]
#
                                ...
                                if (len(bufferList) > pktHdrOffset + 4 + msgLen + 2):
                                    ...
                                    if CRC_calc == usnCRC16:
                                        if (isMmMessageDetected or isCmMessageDetected):
                                            ...
                                            value = [x/1000.0, y/1000.0, z/1000.0, qw/10000.0, qx/10000.0, qy/10000.0, qz/10000.0, vx/1000.0, vy/1000.0, vz/1000.0, ax/1000.0,ay/1000.0, az/1000.0, HedgeAdr, timestamp]
