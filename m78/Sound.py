...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 00:02:11 2019
...
#                                    print ('hedge12_position',x_out)
                                ...
                                #    hedge_quan=x_out[3:7]
                                    ...
                                    buffer=spatialization(self.azimuths,self.HRTF_data,data,azimuths_body)*(1/(hedge_obj_dis+1)**2)#spatialize soundfile according to azimuth
